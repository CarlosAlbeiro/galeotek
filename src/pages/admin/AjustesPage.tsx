  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Configuración general del panel.</p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Edición de textos del sitio, cambio de tema y activación de secciones llegarán en la próxima versión.
            </p>
          </div>
        </div>
      </div>
