      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center px-4 pb-20 pt-16 text-center sm:px-6 sm:pt-24 md:pt-32">
          ...
          <motion.h1
            ...
            className="mt-6 max-w-3xl text-balance text-4xl font-bold leading-tight sm:text-5xl md:text-6xl"
          >
          ...
          >
            <Button
              asChild
              size="lg"
              className="h-12 gap-2 bg-[var(--gradient-primary)] px-6 text-primary-foreground shadow-glow hover:opacity-95"
            >
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        <div className="mb-10 flex flex-col items-center text-center">
          ...
          <p className="mt-3 max-w-xl text-sm text-muted-foreground">
            Un solo aliado para tu tecnología. Sin enredos, sin sorpresas.
          </p>
        </div>
          ...
          <div className="relative grid gap-10 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-3 text-muted-foreground">
                Todo lo esencial para que tu casa funcione perfecto: revisión eléctrica, mantenimiento
                de equipos y asesoría de seguridad. En una sola visita.
              </p>
              <ul className="mt-6 space-y-2.5">
                {[
                  "Revisión eléctrica completa",
                  "Mantenimiento de 1 computador",
                  "Asesoría de cámaras de seguridad",
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                >
                  <a href={waLink("Hola, me interesa el paquete Hogar en Orden.")} target="_blank" rel="noopener noreferrer">
                    Solicitar paquete
                  </a>
                </Button>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10 sm:px-6">
        <div className="relative overflow-hidden rounded-2xl border border-primary/30 bg-[var(--gradient-primary)] p-8 text-center shadow-glow">
          <h3 className="text-2xl font-bold text-primary-foreground sm:text-3xl">
            ¿Listo para resolver tu tecnología hoy?
          </h3>
