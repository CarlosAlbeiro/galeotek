...
const VALUES = [
  {
    icon: Sparkles,
    title: "Claridad",
    text: "Hablamos sin tecnicismos innecesarios. Entiendes qué se hace y por qué.",
  },
  {
    icon: ShieldCheck,
    title: "Soluciones reales",
    text: "Resolvemos el problema de fondo, no parches que duran un par de semanas.",
  },
  {
    icon: HeartHandshake,
    title: "Acompañamiento",
    text: "No desaparecemos al terminar. Soporte y asesoría continua después del servicio.",
  },
];
        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              {SITE.name} nace para resolver, en un solo lugar, todo lo tecnológico que tu hogar y
              tu emprendimiento necesitan. Combinamos software, electricidad, seguridad y asesoría
              con un trato humano y honesto.
            </p>
            <p className="mt-3 text-muted-foreground">
              Atendemos en {SITE.coverage}, con disponibilidad por WhatsApp y visitas programadas.
            </p>
          </div>
